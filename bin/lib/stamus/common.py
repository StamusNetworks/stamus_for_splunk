...
FIELDS_SUBSTITUTION = (['http.user_agent', 'http_user_agent'], ['http.user_agent_count', 'http_user_agent_count'], ['tls.ja3', 'tls_ja3'], ['tls.ja4', 'tls_ja4'], ['tls.ja3_count', 'tls_ja3_count'], ['tls.ja4_count', 'tls_ja4_count'], ['ssh.client', 'ssh_client'], ['ssh.client_count', 'ssh_client_count'])

FIELDS_SUBSTITUTION_DICT = {'http.user_agent': 'http_user_agent', 'http.user_agent_count': 'http_user_agent_count', 'tls.ja3': 'tls_ja3', 'tls.ja3_count': 'tls_ja3_count', 'tls.ja4': 'tls_ja4', 'tls.ja4_count': 'tls_ja4_count', 'ssh.client': 'ssh_client', 'ssh.client_count': 'ssh_client_count'}
